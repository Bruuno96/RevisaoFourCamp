...
public class UtilDateTime {
    ...
    public static void diferencaDataAteJava7() throws ParseException {
        ...
        int dias = (int) (diffEmMil / (1000 * 60 * 60 * 24)); // Milisegundos * Segundo * Minuto * Hora
        System.out.println("Usando método diferencaDataAteJava7: "+diff);
//        System.out.println(dias);
    ...
    public static void diferencaDataJava8() {
        ...
        System.out.println("A diferença é de "+dias+" dia(s) "+meses+" meses e  "+ano+" ano(s)");

        System.out.println("Usando método diferencaDataJava8: Dias "+dias+"\nMeses "+meses);
    }
